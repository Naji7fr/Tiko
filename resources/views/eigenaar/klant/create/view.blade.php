{{-- klant.view — Klant toevoegen (eigenaar) --}}
@extends('layouts.app')
...
<div class="page-header">
    <div class="container">
        <h1><i class="fas fa-user-plus me-3"></i>Klant toevoegen</h1>
        <p class="mb-0 mt-2 opacity-90">Voeg klantgegevens toe zonder account</p>
    </div>
</div>
...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('eigenaar.klanten.store') }}" novalidate>
                @csrf
