...
<div class="page-header">
    <div class="container">
        ...
        <p class="mb-0 mt-2 opacity-90">Maak een nieuwe afspraak aan</p>
    </div>
</div>
                    ...
                    <form action="{{ route('afspraken.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                                ...
                                <option value="bevestigd" {{ old('status') == 'bevestigd' ? 'selected' : '' }}>Bevestigd</option>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('notes') is-invalid @enderror" 
                                      ...
                                      placeholder="Optionele notities over de afspraak...">{{ old('notes') }}</textarea>
                            @error('notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-2"></i>Afspraak Opslaan
                            </button>
