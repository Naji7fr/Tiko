...
<div class="page-header">
    <div class="container">
        ...
        <p class="mb-0 mt-2 opacity-90">Kies behandeling, specialist, datum en tijd.</p>
    </div>
</div>
                ...
                <div class="col-md-6">
                    ...
                    <select name="medewerker_id" id="medewerker_id" class="form-select" required>
                        ...
                        @foreach($medewerkers as $medewerker)
                            <option value="{{ $medewerker->id }}" {{ old('medewerker_id') == $medewerker->id ? 'selected' : '' }}>{{ $medewerker->gebruiker?->volledig_naam ?? 'Onbekend' }}</option>
                        @endforeach
                    </select>
                </div>
